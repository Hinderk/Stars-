...
""" This module is used to define style sheets for the game's interface """
...
class StyleSheet(Enum):
    """ GUI elements & their style sheets """
    GENERALGUI = _STYLE_0
    STARMAP = _STYLE_1
    SIMPLESETUP = _STYLE_2
    ADVANCEDSETUP_1 = _STYLE_2
...
def get_size():
    """ Return the size of the game window (width x height) """
    return [2400, 1350]
