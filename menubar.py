...
class Menu(QtWidgets.QMenuBar):
    ...
    def __init__(self, form):
        ...
        self.actionToolbar = QtGui.QAction(self)
        self.actionToolbar.setCheckable(True)
        self.actionToolbar.setChecked(True)
        self.actionToolbar.setText("Toolbar")
        self.actionToolbar.setStatusTip("Decide whether to show or hide the tool bar of the game ...")
        ...
        MenuView.addAction(self.actionToolbar)
