...
class Stars(QtWidgets.QMainWindow):
    ...
    def SetupUI( self ) :
        ...
        self.checkBox = QtWidgets.QCheckBox(self.CentralWidget)  # REMOVE
        ...
        self.radioButton = QtWidgets.QRadioButton(self.CentralWidget)   # REMOVE
        ...
        NewAction = QtWidgets.QAction( self )
        #Icon = QtWidgets.QIcon( ':/Menu/Science' )
        #NewAction.setIcon( Icon )
